...
\newcommand{\deffuncparam}[7]{%
    \expandafter\newcommand\csname domain#1\endcsname{\ensuremath{#4}}%
    \expandafter\newcommand\csname codomain#1\endcsname{\ensuremath{#6}}%
    \expandafter\newcommand\csname decl#1\endcsname{\ensuremath{#2_{#3} : #4 #5 #6}}%
    \expandafter\newcommand\csname funcname#1\endcsname[1]{\ensuremath{#2_{##1}}}%
    \expandafter\newcommand\csname body#1\endcsname[2]{\ensuremath{#7}}%
