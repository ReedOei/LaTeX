...
% \let\oldfrac\frac
% This almost works (i.e., lets you write \frac{x} to get \frac{1}{x}), but then you have to write \frac[x]{y} with square brackets. Idk enough about latex atm to fix this, or care enough to google, but someday maybe I will so I'm leaving it here.
% \renewcommand{\frac}[2][1]{\oldfrac{#1}{#2}}
...
\newcommand{\ord}{\text{ord}} % order of an element
\newcommand{\height}{\text{ht}} % height of a term/formula
...
\ifdefined\argument\else\newtheorem{argument}{Argument}\fi
\ifdefined\assertion\else\newtheorem{assertion}{Assertion}\fi
